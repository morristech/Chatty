...
//        startActivity(intent);
    ...
    private void showAlertDialog(String message, boolean isCancelable) {
        dialog = buildAlertDialog(getString(R.string.login_error_title), message, isCancelable, SignInActivity.this);
        dialog.show();
    }
    ...
    private AlertDialog buildAlertDialog(String title, String message, boolean isCancelable, Context context) {
